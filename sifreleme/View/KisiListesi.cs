...
namespace sifreleme
{
    public partial class KisiListesi : Form
    {
        ...
        private void KullaniciListesi_Load(object sender, EventArgs e)
        {
            ...
            goster.Kisi_Listesi(dataGridView1);
        }
        ...
        {
            kisi_id = Convert.ToInt16(dataGridView1.CurrentRow.Cells[2].Value.ToString());
            kisi_ad = dataGridView1.CurrentRow.Cells[0].Value.ToString();
            Sohbet f = new Sohbet();
            f.Show();
            f.Text = kisi_ad;
        }
